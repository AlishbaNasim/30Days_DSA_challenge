...
// 2. *Object-Oriented Programming (OOP) Approach:*
var simple_calculator = /** @class */ (function () {
    function simple_calculator() {
    }
    simple_calculator.prototype.add = function (num1, num2) {
        console.log(num1 + num2);
    };
    simple_calculator.prototype.sub = function (num1, num2) {
        console.log(num1 - num2);
    };
    simple_calculator.prototype.multiply = function (num1, num2) {
        console.log(num1 * num2);
    };
    simple_calculator.prototype.divide = function (num1, num2) {
        console.log(num1 / num2);
    };
    return simple_calculator;
}());
var new_calaculator = new simple_calculator();
